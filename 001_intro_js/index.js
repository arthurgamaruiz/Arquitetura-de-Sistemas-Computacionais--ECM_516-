...
// console.log(1 === '1')             // não realiza coerção. Considera valores e tipos para a comparação --> utilizar apenas este
// console.log(1 == 1)
...
//Execução Síncrona (bloqueante) e Assíncrona (não bloqueante)
...
//Promises: Uma Promise é um objeto por meio do qual uma função pode propagar um resultado ou um erro em algum momento no futuro.
//1 + 2 + 3 + .... + n
//function e arrow function funcionam para promises
//demorando:
...
// console.log(res)
// const calculoDemorado = (n) =>{
//     //promise associada à função
//     return new Promise((resolve, reject) => {   //resolve e reject são duas funções para sucesso ou rejeição, respectivamente
//         if(n<0){
//             reject(' Digite apenas valores maiores ou iguais a zero')
//         }
//         else{
//             let cont=0;
//             for(let i=0; i<=n; i++)
...
//     }) 
// }
// const minhaPromise = calculoDemorado(-1)
// //tratamento de promises    then/catch
// minhaPromise
// .then((resultado) => {console.log(`Resultado: ${resultado}`)})  //executa a computação demorada e faça a função assiciada (parâmetro da função then) se sucesso
// .catch((erro) => {console.log(`Erro: ${erro}`)})                //executa catch se rejeição
// console.log('A')
const calculoRapido = (n) => {
    return n>=0 ? Promise.resolve((n+1)*n/2): Promise.reject('Apenas valores maiores ou iguais a zero')
}
// calculoRapido(10000)
...
// calculoRapido(10)
// .then((res) => {
//     calculoRapido(res).then(res2 =>{
//         calculoRapido(res2).then(res3 =>{
//             calculoRapido(res3).then(res4 =>{
//                 console.log(res4)
//             })
//         })
//     })
